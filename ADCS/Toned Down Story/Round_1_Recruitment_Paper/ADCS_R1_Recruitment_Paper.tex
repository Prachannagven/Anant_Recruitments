...
\noindent \textbf{Rick:} “Good news, Morty! We’ve got this celestial teleporter that came with the map. Bad news? The cosmic genius that built it didn’t account for Earth’s rotation. The teleporter only takes coordinates in the Earth-Centered Inertial (\href{https://www.researchgate.net/figure/Fig-C1-Direction-of-vernal-equinox_fig2_258438421}{ECI}) Frame. That’s a frame fixed to the stars, Morty. Conveniently, ECI and ECEF align perfectly at 1200 GMT every day. So, get to it—convert the hill’s coordinates to the ECI frame using today’s time.” \\
